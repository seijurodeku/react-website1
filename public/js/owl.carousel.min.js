!(function (a, b, c, d) {
  ...
  function g (a) {
    ...
    var f = a
    for (b in f) {
      if (((d = f[b]), typeof e.style[d] !== 'undefined')) {
        return (e = null), [d, b]
      }
    }
    return [!1]
  ...
  (e.Pipe = [
    ...
    },
    {
      ...
      run: function () {
        ...
        var b = this.$stage.children('.cloned')
  ...
  (e.prototype.setup = function () {
    ...
    (this.settings === null || this._breakpoint !== d) &&
  ...
  (e.prototype.eventsRouter = function (a) {
    var b = a.type
    b === 'mousedown' || b === 'touchstart'
      ? this.onDragStart(a)
      : b === 'mousemove' || b === 'touchmove'
        ? this.onDragMove(a)
        : b === 'mouseup' || b === 'touchend'
          ? this.onDragEnd(a)
          : b === 'touchcancel' && this.onDragEnd(a)
  }),
  ...
  (e.prototype.onDragStart = function (d) {
    ...
    if (
      ...
      e.which === 3 || this.state.isTouch)
    ) {
      return !1
    }
    if (
      (e.type === 'mousedown' && this.$stage.addClass('owl-grab'),
      this.trigger('drag'),
  ...
  (e.prototype.onDragEnd = function (b) {
    ...
    if (this.state.isTouch) {
      if (
        (b.type === 'mouseup' && this.$stage.removeClass('owl-grab'),
            ...
            a.proxy(function (a, g) {
              return (
                b > g - d && g + d > b
                  ...
                  : this.op(b, '<', g) &&
                    this.op(b, '>', f[a + 1] || g - e) &&
                    (c = this.state.direction === 'left' ? a + 1 : a),
                c === -1
              )
            }, this)
          ),
  ...
  (e.prototype.to = function (c, d) {
    if (this.settings.loop) {
      ...
      var h = this.current() + e

      var i = g - h < 0 ? !0 : !1

      var j = this._clones.length + this._items.length
  ...
  (e.prototype.add = function (a, b) {
    ...
    this._items.length === 0 || b === this._items.length
      ? (this.$stage.append(a),
      this._items.push(a),
      this._mergers.push(
        1 *
  ...
  (e.prototype.trigger = function (b, c, d) {
    ...
    return (
      this._supress[b] ||
          ...
          this.settings &&
            typeof this.settings[f] === 'function' &&
...
(function (a, b, c) {
  ...
  (d.prototype.play = function (b) {
    ...
    var e = a(b.target || b.srcElement)

    var f = e.closest('.' + this._core.settings.itemClass)

    var g = this._videos[f.attr('data-video')]

    var h = g.width || '100%'

    var i = g.height || this._core.$stage.height()
    g.type === 'youtube'
      ? (c =
              '<iframe width="' +
              h +
...
(function (a) {
    ...
    (this._handlers = {
      ...
      'change.owl.carousel': a.proxy(function (a) {
        if (
          ...
          var c = this._core.maximum()

          var d = this._core.minimum()
          a.data =
                a.property.value > c
                  ? b >= c
                    ? d
      ...
      'changed.owl.carousel': a.proxy(function (a) {
        a.property.name == 'position' && this.draw()
      }, this),
  ...
  (b.prototype.update = function () {
    ...
    var e = this._core.clones().length / 2

    var f = e + this._core.items().length

    var g = d.center || d.autoWidth || d.dotData ? 1 : d.dotsEach || d.items
    if (
      (d.slideBy !== 'page' && (d.slideBy = Math.min(d.slideBy, d.items)),
      d.dots || d.slideBy == 'page')
    ) {
  ...
  (b.prototype.draw = function () {
    ...
    var f = (this._core.$stage.children(),
  ...
  var c = function (d) {
    ...
    a(b).on(
      ...
      a.proxy(function () {
        ...
        var d = (this._hashes[a] && c.index(this._hashes[a])) || 0
