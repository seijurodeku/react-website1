...
(function (a) {
  ...
  if (
    ...
    var q = j.getElementsByTagName('head')[0] || k

    var r = j.getElementsByTagName('base')[0]

    var s = q.getElementsByTagName('link')
    ...
    var u = function (b) {
      ...
      var e = (j.compatMode === 'CSS1Compat' && d) || j.body[c] || d
    ...
    var x = function () {
      for (var b = 0; b < s.length; b++) {
        ...
        var g = c.rel && c.rel.toLowerCase() === 'stylesheet'
        e &&
            g &&
            !o[e] &&
